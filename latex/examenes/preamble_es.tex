...
\theoremstyle{normal}
\declaretheorem[style=normal,name=Lema]{lema}
\declaretheorem[style=breakthm,name=Lema]{teolema}
\declaretheorem[style=normal,name=Lema,numbered=no]{lema*}
\declaretheorem[style=normal,name=Observación]{obs}
\declaretheorem[style=normal,name=Observación,numbered=no]{obs*}

\declaretheorem[style=break,name=Proposición]{prop}
...
\declaretheorem[style=break,name=Definición]{defi}
\declaretheorem[style=break,name=Definición,numbered=no]{defi*}
\declaretheorem[style=break,name=Corolario]{col}
\declaretheorem[style=break,name=Corolario,numbered=no]{col*}
\declaretheorem[style=break,name=Ejercicio]{ej}
\declaretheorem[style=break,name=Ejercicio,numbered=no]{ej*}
\declaretheorem[style=break,name=Ejemplo]{example}
